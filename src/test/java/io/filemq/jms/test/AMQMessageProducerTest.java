...
public class AMQMessageProducerTest {
  ...
  public AMQMessageProducerTest() {
  }
  
  @BeforeClass
  public static void initClass() {
    connectionFactory = new ActiveMQConnectionFactory("vm:(broker:(tcp://localhost:61616)?persistent=true&useJmx=false)?marshal=true&wireFormat.cacheEnabled=false");
    destination = new ActiveMQQueue("TEST.FOO");
  }
